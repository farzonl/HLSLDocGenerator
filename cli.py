...
parser.add_argument('-qut, --gen_dxc_tests',  dest='query_unique_types', action='store_true', default=False)
parser.add_argument('-gdt, --gen_dxc_tests',  dest='gen_dxc_tests', action='store_true', default=False)
